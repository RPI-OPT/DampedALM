...
%% this is the implementation for solving QP using activeset method and 
%matlab's quadprog for weakly-convex objective
clear; close all;
rng(20220927,"twister" );% same seed for debug!
...
%%
rand('seed',20220927); randn('seed',20220927); 
...
[variances{1}.obj_sqp,means{1}.obj_sqp] = var(objavg1);
[variances{1}.time_sqp, means{1}.time_sqp] = var(timeavg1);

[variances{1}.obj_dpalm,means{1}.obj_dpalm] = var(objavg2);
[variances{1}.time_dpalm, means{1}.time_dpalm] = var(timeavg2);

[variances{1}.obj_mat,means{1}.obj_mat] = var(objavg3);
[variances{1}.time_mat, means{1}.time_mat] = var(timeavg3);

%%

% Open the file for writing
fileID = fopen('Tables/mean_and_variance_activeset.txt', 'w');

fprintf(fileID, '%s\n', '                   active_set_fval  active_set_time       DPALM_fval     DPALM_time     quadprog_fval    quadprog_time   ');
fprintf(fileID, '%s\n', ' ');

fprintf(fileID, '%s\n', ['mean for mu = 1e-3     ',...
        num2str(means{1}.obj_sqp,3), '             ', num2str(means{1}.time_sqp,3), '              ',...
        num2str(means{1}.obj_dpalm,3), '       ', num2str(means{1}.time_dpalm,3), '          ', ...
        num2str(means{1}.obj_mat,3), '       ', num2str(means{1}.time_mat,3)]);
fprintf(fileID, '%s\n', ['var for mu = 1e-3      ',...
        num2str(variances{1}.obj_sqp,3), '              ', num2str(variances{1}.time_sqp,3), '             ',...
        num2str(variances{1}.obj_dpalm,3), '       ', num2str(variances{1}.time_dpalm,3), '            ', ...
        num2str(variances{1}.obj_mat,3), '       ', num2str(variances{1}.time_mat,3)]);

fprintf(fileID, '%s\n', ['mean for rho = .1    ',...
        num2str(meanvalues{1}.obj_sqp,3), '              ', num2str(meanvalues{1}.time_sqp,3), '            ',...
        num2str(meanvalues{1}.obj_dpalm,3), '       ', num2str(meanvalues{1}.time_dpalm,3), '           ', ...
        num2str(meanvalues{1}.obj_mat,3), '       ', num2str(meanvalues{1}.time_mat,3)]);
fprintf(fileID, '%s\n', ['var for rho = .1     ',...
        num2str(varianceval{1}.obj_sqp,3), '              ', num2str(varianceval{1}.time_sqp,3), '             ',...
        num2str(varianceval{1}.obj_dpalm,3), '       ', num2str(varianceval{1}.time_dpalm,3), '            ', ...
        num2str(varianceval{1}.obj_mat,3), '       ', num2str(varianceval{1}.time_mat,3)]);

fprintf(fileID, '%s\n', ['mean for rho = 1     ',...
        num2str(meanvalues{2}.obj_sqp,3), '                   ', num2str(meanvalues{2}.time_sqp,3), '            ',...
        num2str(meanvalues{2}.obj_dpalm,3), '       ', num2str(meanvalues{2}.time_dpalm,3), '            ', ...
        num2str(meanvalues{2}.obj_mat,3), '       ', num2str(meanvalues{2}.time_mat,3)]);
fprintf(fileID, '%s\n', ['var for rho = 1      ',...
        num2str(varianceval{2}.obj_sqp,3), '              ', num2str(varianceval{2}.time_sqp,3), '             ',...
        num2str(varianceval{2}.obj_dpalm,3), '       ', num2str(varianceval{2}.time_dpalm,3), '            ', ...
        num2str(varianceval{2}.obj_mat,3), '        ', num2str(varianceval{2}.time_mat,3)]);

fprintf(fileID, '%s\n', ['mean for rho = 10    ',...
        num2str(meanvalues{3}.obj_sqp,3), '                  ', num2str(meanvalues{3}.time_sqp,3), '           ',...
        num2str(meanvalues{3}.obj_dpalm,3), '       ', num2str(meanvalues{3}.time_dpalm,3), '           ', ...
        num2str(meanvalues{3}.obj_mat,3), '       ', num2str(meanvalues{3}.time_mat,3)]);
fprintf(fileID, '%s\n', ['var for rho = 10     ',...
        num2str(varianceval{3}.obj_sqp,3), '              ', num2str(varianceval{3}.time_sqp,3), '          ',...
        num2str(varianceval{3}.obj_dpalm,3), '       ', num2str(varianceval{3}.time_dpalm,3), '            ', ...
        num2str(varianceval{3}.obj_mat,3), '       ', num2str(varianceval{3}.time_mat,3)]);
